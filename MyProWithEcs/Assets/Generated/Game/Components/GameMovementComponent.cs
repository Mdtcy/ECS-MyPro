...
public partial class GameEntity {
    ...
    public void AddMovement(float newHorizontalValue, float newVerticalValue) {
        var index = GameComponentsLookup.Movement;
        var component = (MovementComponent)CreateComponent(index, typeof(MovementComponent));
        component.horizontalValue = newHorizontalValue;
        component.verticalValue = newVerticalValue;
        AddComponent(index, component);
    }

    public void ReplaceMovement(float newHorizontalValue, float newVerticalValue) {
        var index = GameComponentsLookup.Movement;
        var component = (MovementComponent)CreateComponent(index, typeof(MovementComponent));
        component.horizontalValue = newHorizontalValue;
        component.verticalValue = newVerticalValue;
