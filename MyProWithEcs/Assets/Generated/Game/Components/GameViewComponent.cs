...
public partial class GameEntity {
    ...
    public void AddView(IViewController newIViewControllerInstance) {
        var index = GameComponentsLookup.View;
        var component = (ViewComponent)CreateComponent(index, typeof(ViewComponent));
        component.IViewControllerInstance = newIViewControllerInstance;
        AddComponent(index, component);
    }

    public void ReplaceView(IViewController newIViewControllerInstance) {
        var index = GameComponentsLookup.View;
        var component = (ViewComponent)CreateComponent(index, typeof(ViewComponent));
        component.IViewControllerInstance = newIViewControllerInstance;
