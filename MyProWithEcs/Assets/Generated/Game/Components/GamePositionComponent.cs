...
public partial class GameEntity {
    ...
    public void AddPosition(UnityEngine.Vector3 newPositionValue) {
        var index = GameComponentsLookup.Position;
        var component = (PositionComponent)CreateComponent(index, typeof(PositionComponent));
        component.PositionValue = newPositionValue;
        AddComponent(index, component);
    }

    public void ReplacePosition(UnityEngine.Vector3 newPositionValue) {
        var index = GameComponentsLookup.Position;
        var component = (PositionComponent)CreateComponent(index, typeof(PositionComponent));
        component.PositionValue = newPositionValue;
